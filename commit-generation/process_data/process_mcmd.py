...
def load_mcmd_data(args, tokenizer, mode, pool):
    ...
    # features = [convert_examples_to_features(item) for item in tuple_examples]
...
if __name__ == "__main__":
    ...
    examples, test_dataset = load_mcmd_data(args, tokenizer, "test", pool)
